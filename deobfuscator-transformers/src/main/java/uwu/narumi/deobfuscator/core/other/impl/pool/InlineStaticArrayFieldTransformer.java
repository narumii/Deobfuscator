...
import uwu.narumi.deobfuscator.api.asm.matcher.InstructionMatcher;
import uwu.narumi.deobfuscator.api.asm.matcher.result.Result;
import uwu.narumi.deobfuscator.api.asm.matcher.rule.Match;
import uwu.narumi.deobfuscator.api.asm.matcher.rule.group.OrMatch;
import uwu.narumi.deobfuscator.api.asm.matcher.rule.impl.*;
...
public class InlineStaticArrayFieldTransformer extends Transformer {
  ...
  private void extractData(ClassWrapper classWrapper, MethodNode methodNode, Context context) {
    Arrays.stream(methodNode.instructions.toArray())
        .filter(SET_STATIC_MATCHER::test)
        ...
        .forEach(
            node -> {
              ...
              {
                for (Result result : ARRAY_STORE_MATCHER.bind(methodNode).collect()) {
