package uwu.narumi.deobfuscator.transformer.composed.bozar.v1_6;
...
import uwu.narumi.deobfuscator.transformer.impl.bozar.v1_6.BozarControlFlowTransformer;
...
public class BozarTransformer extends ComposedTransformer {
    ...
    public List<Transformer> transformers() {
    	return Arrays.asList(
        		...
        		new BozarControlFlowTransformer(),
